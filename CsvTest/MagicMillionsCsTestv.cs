...
namespace CsvTest
{
	public sealed class MagicMillionsCsvTestMap : ClassMap<MagicMillionsCsTestv>
	{
		public MagicMillionsCsvTestMap()
		{
	...
	public class MagicMillionsCsTestv
	{
